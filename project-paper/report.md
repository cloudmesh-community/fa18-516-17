...
## Dataset
In order to appreciate the storage and computational requirements it is important to understand the idiosyncrasies of a retail data set.  I’ll describe the basics here before I describe the subset I chose for this project. ![Retail Project Diagram](images/ retailprojectdiagram.PNG){#fig:Retail Project Diagram}
